...
public class MyBirth {
	...
	/*
	 # 캡슐화(은닉): 데이터 보호의 목적으로 사용하는 oop 기술중 하나 object orient protect
	...
	/*
	 # getter method
	 1.getter는 숨겨진 변수의 값을 참조할 때 사용하는 메서드다.
	 2.setter와 마찬가지로 public제한을 통해 외부에 메서드를 공개하고
	   이름은 일반적으로 get + 멤버변수이름으로 지정한다.
	 */
